export default {
    accounts: {
      ...
      openai: {
        ...
        fastMode: 'Fast 模式',
        fastModeDesc:
          '仅对当前 ChatGPT OAuth / Setup Token 账号生效。开启后该账号的请求会强制使用 service_tier=priority；关闭后会移除客户端请求中的 Fast tier。',
        fastModeBulkDesc:
          '批量设置所选 ChatGPT 账号的 Fast 模式；开启会强制 priority，关闭会恢复普通模式。',
        fastModeBadge: 'Fast',
        fastModeEnabledHint: '该 ChatGPT 账号已开启 Fast（priority）模式',
