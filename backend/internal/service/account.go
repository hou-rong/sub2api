...
func (a *Account) UsesKimiCodingAPI() bool {
	...
	// v0.1.179 introduces explicit protocol selection for Kimi API-key
	// accounts. Any stored protocol is an intentional CN-provider setup and
	// must not be mistaken for a legacy Coding account merely because base_url
	// is empty (adaptive accounts keep their URLs in api_base_urls).
